...
gui_main.func_add_onclick("m_img_int", function() {
    gui_main.m_show_dialog(true, "VOID-777", "VOID-777 - Oh, deixe comigo\nque eu vou te explicar tudo.\nBasicamente, você só precisa\ndesviar dos elementos pelo maior\ntempo possível para obter a\nmaior pontuação no final.");
});
...
setInterval(() => {
    ...
    if (verify_cll_objs()) {
       ...
       document.getElementById("m_pipe").style.animation = "none";

       gui_main.m_show_dialog(true, "VOID-777", "VOID-777 - Oh,\nParabéns, essa foi sua\npontuação: " + m_tm_pt);
    }
}, 10);